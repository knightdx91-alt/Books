...
chapters + back matter, with a navigable TOC. Pure stdlib.
    ...
    python3 tools/make_epub.py books/the-gift
    python3 tools/make_epub.py books/saeren/saeren-chronicles-book-2 --out /tmp/test.epub
...
def main():
    ...
    ap.add_argument("book", help="path to the book folder, e.g. books/the-gift")
