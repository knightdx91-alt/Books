...
<!-- Word count: ~5,050 | Structure: CHRONOLOGICAL / ACTION. Function: ESCALATION. ACT THREE opens. The approach to the source: she steps through the seam (Ch.15 end) into the country above the cavern; the human + Horror threats converge on the only place a door can be drawn. The Marick/Fen thread re-intersects: Marick has followed the pull west to the source ahead of them (the candle who picked up the chalk, drawn to the one large thing), and draws his last working at the cavern mouth to "help" / to be the one who finally sees; his working tears wide and the cold comes through; CAMERA CUT on Marick's end (he goes into his own door / the cold takes him -- not shown). FEN SURVIVES -- Viridia's hand, the side he chose at the lab. The found-family holds the LINE so she can reach the pedestal: Drake at the cavern mouth (cold-handed, closing the human-side doors with the death-mark so she does not have to); the Dangris standing-with at the seam, shadowless against the cold; Amber + Alice + the bond; Raizen braced. END HOOK: she reaches the pedestal, the pool, the split symbol, two names, and sets her hand to the source for the last working (do NOT spill into the working -- that's Ch.17). Cavern matched to Bk2 Ch.18 / Bk1 Ch.14. Death-mark closes DOORS not the source. Void abstract, unnamed. Grief inward (no public break). YA: cut the camera on the worst; hope/connection load-bearing. Em-dash <=4. -->
