# Chapter 8: The Man Who Picked Up the Chalk

<!-- Word count: ~4,950 | Structure: chronological scene (journey west, arrival at the lab, the close that changes nothing). Function: REVERSAL. ACT TWO opens. The made cut from the grey west takes a shape and a place: a low stone laboratory and a man named Marick, a forty-year candle handed the whole dark half in the rebirth, who read a worn warning and decided it did not matter and picked up the chalk. Introduce Fen, his young assistant (plant only; do not telegraph). THE GUT: Marick's portal is a symptom. She closes it with the Death mark and the pull does not slow at all; the tearing was never the door. The made cut only opened the rim's leaning a little faster. END HOOK: the proximate cause is found and named and shut, and nothing changes; the real cause is what she is. Anchor: the chalk dust still on his fingers, and the mark drawn clean over a closed door, and the rim leaning in exactly as hard the instant after as the instant before. -->
