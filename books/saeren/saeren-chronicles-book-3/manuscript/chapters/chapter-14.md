# Chapter 14: The Brink

<!-- Word count: ~5,000 | Structure: accelerated chronological (ACTION). Function: ESCALATION. The largest Horror incursion yet, converging with the human conflict; a major near-loss (Amber); the world at the brink. The wholesale-Death-symbol temptation RETURNS (seal every portal / close the source) and is REFUSED -- it edges toward killing magic again, the council's crime in a new coat. END HOOK: she commits to balance despite what it will take (follows Ch.13's named cost: the permanent valve, the whole of her long life in a doorway, the way it took Bella). Voice matched to Ch.10-13. Action sentences kept short and able to move; reflection clustered, not strewn through the incursion. Death symbol = closes PORTALS, never the source. Raizen human, dark ordinary eyes. Grief inward; no public break (the Ch.10 break is past). Void abstract, unnamed. YA: camera cuts on the worst; hope/connection load-bearing. Em-dash <=4. -->
