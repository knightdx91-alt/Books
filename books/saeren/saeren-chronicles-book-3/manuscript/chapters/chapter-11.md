# Chapter 11: The Ledger Reopens

<!-- Word count: ~4,900 | Structure: chronological, quieter (aftermath of knowing). Function: the accounting resumes after the midpoint gut-punch. CONCRETE anchor: Mrs. Zoran arrives at Wend on foot; the kitchen table; a cup of tea that goes cold. Amber's question in its hardest form — asked in real scene, not narrated. Political-world-worsening as specific event: a letter arrives from the capital that cannot be ignored. END HOOK: a human crisis (not a Horror) forces her hand before she has the answer. Grief inward throughout; the Ch.10 private break is closed, the door shut again. The temptation to un-mend (monstrous, dismissed). Anaphora <=2 deliberate instances. Em-dash <=4. -->
