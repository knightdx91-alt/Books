...
#
# Output: delivery/production/Saeren-Chronicles-Book-Three-6x9-interior-<REV>-PDFX1a.pdf
...
IN="${1:-$ROOT/delivery/production/Saeren-Chronicles-Book-Three-6x9-interior${SUF}.pdf}"
