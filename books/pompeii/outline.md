# Outline v2 — "Pompeii" (working title) — MACRO-STRUCTURE RE-ARCHITECTURE

> STRUCTURE-ONLY PASS. This file re-shapes the book's macro-structure to break the
> uniform ~45-near-equal-chapter mold. It does NOT rewrite prose, characters, theme,
> voice, or canon — every binding author decision in STATE.yaml survives unchanged
> (Greece-first; Oracle gives WHERE not WHEN; Valens/Lupus framed over the legate's
> wife; Lucius & Aelia over ~9 years; arrives ~70 AD under Vespasian; Vesuvius 79 AD
> under Titus; Fenn reveals the WHEN; she STAYS and dies in the ash as an ACTIVE
> choice; NO modern coda, book ends in 79 AD; first-person past retrospective).
> Drafted **Ch.1 "The Drawer"** and **Ch.2 "Too Accurate to Be Fake"** are treated as
> FIXED openers; the new structure honors their content and keeps them at their drafted
> lengths.
...
**Chosen structure: FIVE MOVEMENTS with a SLOW-BURN-TO-ERUPTION dynamic — chapters
that SWELL as she sinks into the past and then VIOLENTLY SHORTEN as the ash falls.**
Sectioned as **Movements** (dated, place-named), not "ACT ONE/TWO/THREE."

**Why this premise demands it (not a clean 3-act at 25/50/75):**
1. The story is a *nine-year immersion* bracketed by a two-day modern frame at the front
   and a two-day catastrophe at the back. A symmetrical three-act staircase would flatten
   exactly the thing that makes it Outlander-scale: the long, uneven, sink-into-a-world
   middle. The premise wants **lumpy, asymmetric movements**, not equal acts.
3. The eruption is a *compressed detonation* after an 85% pressure-build. That is the
   textbook case for **slow-burn + short explosive final movement**: the final movement's
   chapters get shorter and shorter (a family talking about bread runs 3,400w; the door
   closing runs 1,600w) so the reading *speed* accelerates into the surge even as the story
...
Note the asymmetry: the "midpoint" lands at ~55%, and the third turn is jammed to ~86% —
this is a slow-burn whose catastrophe occupies only the final ~15%, which is the point.

**Section labels (Movements, dated/place-named — reader-visible or internal, author's call):**
- **Movement I — The Drawer and the Door** (England/the coast, late 1990s → the crossing) · Ch.1–5
- **Movement II — Learning to Exist** (Greece, 70 AD) · Ch.6–13
- **Movement III — The Life She Built** (Campania, ~72–78 AD) · Ch.14–18
- **Movement IV — The Arithmetic** (Campania, the WHEN and the rising dread) · Ch.19–27
- **Movement V — Ash** (the Bay of Naples, late summer 79 AD) · Ch.28–36

**Chapter-count logic:** 36 chapters (down from 45). The count FELL OUT OF THE BEATS, not
from `word_target ÷ floor`: adjacent modern-frame and dread beats were fused into single
richer chapters (Coordinates+Survey; No-Name+the-Mules-refusal; Leaving-Greece+Marriage;
Telling+Preparing; the door-calls+the-law-holds), while the catastrophe was SPLINTERED into
...
# MOVEMENT I — THE DRAWER AND THE DOOR  (late 1990s → the crossing · Ch.1–5 · ~10%)

## Chapter 1 — The Drawer  ·  4,900w  ·  *chronological / single-location*  ·  **[FINAL 2026-07-11 redraft · 5,066w · Genesis Floor 8.5 PASS]**
Mara clears her dead archaeologist father's study and fails, in small human ways, to mourn him.
**Function:** Establish wound, lie ("the dead don't leave"), voice; make the leap inevitable.

## Chapter 2 — Too Accurate to Be Fake  ·  5,100w  ·  *dialogue two-hander*  ·  **[TO REDRAFT — 2026-07-11 restart deleted prior draft]**
Mara tracks the map to an antique shop; the pragmatist shopkeeper and the vanished August Fenn.
**Function:** Deliver the inciting object + first mystery thread; plant re-read seeds. **[INSERT: Fenn marginalia #1]**

## Chapter 3 — Coordinates & the Survey  ·  7,000w  ·  *travel-montage → single-scene tightening*
Mara decodes Fenn's notes, travels to the coast the coordinates name, and surveys a threshold where her instruments behave wrong. *(Fuses old Ch.3 + Ch.4.)*
**Function:** Commit her physically; dramatize the fatal flaw (finishing what she shouldn't); the uncanny enters. Re-read seed #4 (fieldwork kit ritual) begins.

## Chapter 4 — The Threshold  ·  1,800w  ·  *in-medias-res sensation (SHORT PUNCH)*
...
## Chapter 15 — Building a Life  ·  9,200w  ·  *domestic montage-collage (LONG IMMERSIVE)*
...
## Chapter 16 — The Catalogue of Small Days  ·  8,100w  ·  *fragmented vignettes / white space (BREATHING — theme RECEDES)*
...
## Chapter 20 — The Madman on the Coast (Fenn)  ·  9,200w  ·  *long two-hander*
...
## Chapter 22 — Aelia  ·  7,800w  ·  *domestic vignettes (BREATHING — theme RECEDES)*
...
## Chapter 25 — After  ·  4,800w  ·  *quiet chronological (short-ish, recovery valley)*
...
# MOVEMENT V — ASH  (the Bay of Naples, late summer 79 AD · Ch.28–36 · ~83–100%)
> The detonation. Chapters shorten and reading speed accelerates into the surge. NO modern
> coda — the last image is the family in the ash (author-fixed). The retrospective register
> is Mara narrating from inside her last hours, never a future survivor.

## Chapter 28 — The Road to the Door  ·  7,800w  ·  *action travel*
The family travels toward the door amid worsening eruption precursors; a moment of pure family joy mid-catastrophe (singing on the road); the mountain's first true roar.
**Function:** Physical approach; the volcano fully ascendant; one deliberately joyful beat to make the coming loss unbearable.

## Chapter 29 — The Door Will Not Take Them  ·  7,400w  ·  *single-scene catastrophe*  ·  **[TP3 — cruel reveal, ~86%]**
At the door Mara learns the law she suppressed: it opens only for the one it brought — her family cannot pass; Valens already *knew* and came anyway, to send *her* through.
**Function:** The central tragedy detonates; the choice is born; everything reframes. Procedural-flat at the peak. **[INSERT: Fenn's final note — "I told him. You stopped doing the arithmetic. So would I."]**

## Chapter 30 — The Hour  ·  2,600w  ·  *single-scene, fast/fragmenting (SHORT PUNCH)*
...
## Chapter 32 — The Law of the Door  ·  3,200w  ·  *two-hander at the door (SHORT)*
In a lull Valens drags Mara back and begs her through (says he never loved her — a lie she knows is a lie); they test whether a child can pass; the law holds. *(Fuses old Ch.39 + Ch.40.)*
**Function:** Re-test the choice at maximum pressure; close every escape. Cultural vocab "the one it brought" lands.

## Chapter 33 — What She Carries  ·  4,200w  ·  *single-scene, slowed time*
With minutes left, Mara chooses — rendered in action, not speech: she drops the camera, the slides, the watch, the map, and lifts Aelia; she lets the door close.
**Function:** The decision (STAY & DIE, author-fixed), as ACTIVE agency — the door is a live exit she turns from. Oracle seed #1 pays off ("keep nothing you can carry").

## Chapter 34 — The Last Ordinary Thing  ·  3,400w  ·  *quiet single-scene (SHORT)*
In the shelter as the world ends, the family has a final almost-mundane hour; they talk about bread; Valens re-ties Aelia's sandal — one last knot.
**Function:** The emotional-residue chamber; the tenderness is everything, the horror offstage.

## Chapter 35 — What the Ash Keeps  ·  7,400w  ·  *interior memory-braid + object-meditation collage*
In the long dark Mara's mind travels the whole of it — Theano's prophecy meaning exactly what it always meant (mercy, not cruelty); the conservator catalogues her own grave with love; the "function unknown" irony lands in *her* mouth. *(Fuses old Ch.43 + Ch.44.)*
**Function:** Pay off Theano and the motif convergence from INSIDE 79 AD — no museum, no excavator, no modern frame. To be remembered ≠ to be alive; she chose alive.

## Chapter 36 — The Door (Closing)  ·  1,600w  ·  *spare final chapter (SHORTEST — final punch)*
The surge comes — light, heat, silence, not gore; the choice stated plainly once; the central question handed to the reader; the last beat is a knot, a hand, the warmth, the *click*, white space.
**Function:** Deliver the held-back surge and the designed residue (implicated; grieving people who never existed). The book ENDS HERE, in the past. NO authorial verdict.

---

## What changed vs the old 45-chapter outline

**OLD shape:** 45 chapters, all clustered at ~5,200–5,600w (spread ~1.2×, longest ≤2× shortest
by self-imposed cap), split into five labelled ACTS with turning points near the quarter/half
marks and a near-flat chapter-length line — the classic "machine-made uniform" silhouette the
architect rules now flag.
...
- **Long immersive chapters** fall on the beats a saga should linger in: the crossing-landing,
  the Delphi winter, the wedding-hinge voyage, the domestic life, the Fenn interview, the
  full eruption.
- **Turning points jittered and back-loaded** (Oracle ~28%, marriage hinge ~39%, midpoint
  reversal ~55%, cruel reveal ~86%) rather than 25/50/75 — an 85%-build / 15%-detonation curve.
- **Count fell from 45 → 36** by *fusing* adjacent same-energy beats into richer chapters
  (Coordinates+Survey; No-Name+Refusal; Leaving-Greece+Marriage; Town-Knows-Her+Sabina;
