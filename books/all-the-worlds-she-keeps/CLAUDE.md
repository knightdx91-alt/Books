# CLAUDE.md — All the Worlds She Keeps
...
## Project layout
```
book/genesis/all-the-worlds-she-keeps/
...
## How to continue
1. `cd book/genesis/all-the-worlds-she-keeps` and read `STATE.yaml` and `feedback/progress.md`.
