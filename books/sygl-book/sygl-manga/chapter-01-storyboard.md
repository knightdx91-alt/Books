# Sygl Manga — Chapter 1 STORYBOARD (22 pages)

The page-by-page layout blueprint. Expands `chapter-01-script.md` (14 story-pages) to the
locked **22-page** length. Each page: panel count, rough compositions, panel shapes, and the
reading beat. Captions = Bal's dry/wry voice (SOLO — no Amelia until the final whisper).
Spot-color: only Posy's green Terra mark in Ch.1. Bal = Pre-Regrowth (stump, no sygl) EVERY panel.
...
### p.1 — Cold open (4 panels) — the three facts
1 ◫ ECU stump, right thumb rubbing it. CAP: *The stump itches…*
2 ▭ POV up at the flickering mausoleum roof. CAP: *…the roof flickered three days ago…*
3 ▭ Wide: Bal small on the slate roof, rug on knees, drop below. CAP: *…and this spell could drop me forty feet.*
4 ◫ CU calm/amused face. CAP: *Not a good enough reason to stop.* → TITLE.

### p.2 — The one-handed boy (4)
1 ▭ Stones in the air, right hand juggling.
2 ◫ Detail: stump lifts to "catch," misses. CAP: *Habit.*
3 ▭ Wide isolate: Bal alone above, sealed mausoleum behind, lane to trees.
4 ▭ Down-angle: the yard game; a MARKED palm on one boy; group together, Bal apart. SFX *crack*.

### p.3 — The marking, compressed (5) — first flashback
1 ◫ Flashback tint: a child's upturned palm, GREEN coil burning in (Terra). [spot green]
2 ▭ Supper bench: Posy turns her palm over, green light, kids lean; Bal down the bench. [spot green]
3 ◫ Cart on the lane, a stranger, Posy leaving.
4 ◫ Present: Bal's stump, no mark. CAP: *Every child here woke with a mark. Every one.*
5 ▯ Bal watching the closed mausoleum. Beat.

### p.4 — The flicker (4) — the mystery
1 ▭ Flashback: Bal tracing carved figures on the tomb's top edge.
2 ⬛ BIG: the stone roof goes thin — through it: pillars, open floor, a tall pale STATUE facing away.
3 ◫ Stone closes like water; Bal frozen, stump burning.
4 ▭ Present, staring. CAP: *I told myself I made it up. I didn't.* — TURN

### p.5 — The plan (4)
1 ◫ Ladder against the wall, far too short, dead stone above.
2 ◫ `Sygldry Year 2` open to the appendix, finger on a line. CAP: *…holds until the caster's attention breaks.*
3 ▭ Flashback: Fredrick in the doorway shoving books at Bal. FREDRICK: "You'll get more out of these than I will."
4 ▭ Bal reading by candle, dorm asleep. CAP: *I read all forty dull pages first. I don't start what I can't finish.*

### p.6 — The decision (4) — theme beat, dramatized
1 ▭ Wide: four-o'clock bell inside; nobody coming. SFX *bell*.
2 ◫ CU, something hardening. CAP: *I could agree with the verdict until they send me off to be useful.*
3 ◫ Hand smoothing the rug. CAP: *Or go find out whether it missed something.*
4 ◫ Small beat. CAP: *I'm tired of agreeing with them. It's the closest thing to a reason I've got. And it's mine.*

### p.7 — The cast (5) — the hopeful, silly gesture
1 ◫ Bal kneels, lowers the LEFT WRIST STUMP (not a hand) to the carpet. CAP: *I could use my good hand. I never do.*
2 ◫ Tight: stump on the gold threads. CAP: *Some stupid hopeful part of me still thinks a mark will surface there.*
3 ◫ CU mouth. BAL: "Levimotorcorpus."
4 ◫ FX: strain/heat at the stump (NO sygl colour — he's unmarked). SFX *hmmmm*.
5 ▭ The rug lifts a few inches — stops dead, hovering. SFX *fwm*. — TURN

---

## ACT 2 — THE FLIGHT (pp.8–13)

### p.8 — It works (4) — beat-subversion: delight, not destiny
1 ◫ Bal eyeing the gap of air, barks a laugh. BAL: "...ha."
2 ◫ Deadpan, to a rug. BAL: "Higher."
...
2 ◫ Bal still, breathing. CAP: *I'm inside.*

### p.13 — The wrong details (4) — dread
1 ◫ Detail: swept floor, no dust in a 200-yr tomb. CAP: *There should be dust thick enough to write in.*
2 ◫ Detail: two braziers burning. CAP: *Someone keeps two fires lit — where the living can't reach.*
3 ◫ CU stump: the itch is GONE. CAP: *The absence feels stranger than the itch ever did.*
4 ▭ Slow circle; the low worn altar; he stays center. CAP: *How does the sun even get in here?* — TURN

---

## ACT 3 — THE VOICE (pp.14–16)  [the hook, given room]

### p.14 — Approach the wrongness (3)
1 ▭ Bal drawn toward but wary of the altar; braziers steady.
2 ◫ CU: he studies the light falling from the impossible opening.
3 ▯ He turns, alone in the vast quiet. Beat of total stillness.

### p.15 — THE HOOK (3)
1 ◫ Tight on ear/cheek, hair stirring. WHISPER (distinct small bubble — Amelia's FIRST intrusion): "Because it's magic."
2 ⬛ WHIP-PAN: Bal whirls — room empty: braziers, statue facing away, crumpled rug. SFX *whip*.
3 ▭ Empty pillars into dark. CAP: *The temple that should've been empty for two hundred years…* — TURN
...
## RE-PAGINATION MATH (14 story-pages → 22 board-pages)
Split for breathing room + page-turn control: the flight (was 1 page → now pp.8–10),
the temple (was 1 → pp.12–13), the hook (was 1 → pp.14–16), plus decision/plan given full
pages. Panel counts kept LOW on splashes, higher on interior/dialogue pages, to vary rhythm
(avoids the uniform-grid AI tell — same principle as the prose structural-variety rule).

## PER-PAGE ASSET CHECKLIST (what art each page needs)
- Reusable: Bal(pre-regrowth) refs, orphanage ext/yard, mausoleum ext, temple int/statue,
  carpet prop, dorm int.
- New one-off panels: juggling stones, Posy marking (have draft), cart, Fredrick doorway
  (have draft), ladder, candle-reading, the cast (stump on rug), near-loss drop, the
