# Outline — Death and Remembrance

> Standalone paranormal romance. **20 chapters × ~4,800-5,000 words = ~96,000 words**
> (clears the 90k floor with headroom). Single POV: **Alice Haywood, close third, past
...
## ACT ONE — THE RETURN (Ch.1-5, ~24%)

### Chapter 1 — "The Sharp One"  [= author's opening, expanded · VOICE BENCHMARK]
- **POV:** Alice. **Structure:** confession / ordinary-made-strange. **~5,200w.**
- **Beats:** (a) Age 9, the stable death of Mr. Danvers; Alice meets the young man; he
  gives her the bracelet; "You always were a sharp one." (b) Bridge montage: the changed
  awareness, drawn to suffering, the car crash she alone survives, the vow, med school.
  (c) Brookwood, week two: she walks into Amy Garber's room and finds Acheron holding
  Amy's hand. The reunion, the name, "very Greek," the nurses can't see him, the truth-
  dump (I'm Death / the War / the bargain / the bracelet / the scythe & boatman / "I have
  been searching for you for thousands of years"). End on canon button: *"It just depends
  on how you want to live your life, I guess."*
- **Emotional anchor:** the bracelet sliding onto her right wrist "where it felt natural."
- **Surprise:** the cosmic confession delivered with boyish self-deprecation ("I just hope
  I haven't botched the explanation") — humor where dread is expected.
- **Theme:** present (Death at a bedside; healer meets Death).
- **Opening strategy:** as written. **Beat subversion:** the "supernatural reveal" beat —
  genre expects awe/terror; we get a flustered, apologetic god ripping off a bandaid.
- **Writer warnings:** PRESERVE voice; convert present-tense dialogue tags to PAST;
  keep canon lines verbatim; expand sensory ground of the stable; do not over-explain the
  mythos (let it stay as Acheron's rushed, charming infodump). Em-dash gate ≤4.

### Chapter 2 — "Rounds"
- **POV:** Alice. **Structure:** chronological ward day. **~4,800w.**
- **Beats:** Morning after. Alice tries to function — rounds with **Dr. Reyes** (mentor
  introduced), **Jonah** (best-friend resident introduced), the ordinary glory and grind
  of the ward (establish the mortal life she'd lose). She keeps almost-seeing Acheron.
  Returns to Amy: Acheron is there; their first *quiet* conversation as adults; Amy's tart
  charm + her estranged-daughter problem seeded. Alice tests him with questions; he dodges
  the cost.
- **Anchor:** Reyes teaching Alice to find a thready pulse — hands motif established.
- **Surprise:** Alice laughs with Amy in a death-ward — warmth where solemnity is due.
- **Theme:** present. **Opening:** quiet domestic (her apartment, cold coffee — coffee
  obsession seeded). **Beat subversion:** "ordinary world" beat made uneasy — the world is
  already wrong (she can see him now everywhere). **Shareable:** —.
- **Chaos:** Alice's coffee obsession (1st); mind-reading distortion at rounds.

### Chapter 3 — "What He Does"
- **POV:** Alice. **Structure:** single sustained scene. **~4,700w.**
- **Beats:** Alice witnesses Acheron *work* for the first time — a patient passes and she
  watches what Death actually does (gentle, merciful, a hand held). It detonates her lie
  (Death = enemy). She's shaken: the thing she fights is *kind*. First real intimacy
  between them — not romantic yet, but a meeting of two people who tend the dying.
- **Anchor:** the exact moment the monitor flatlines and Acheron's expression — not
  triumph, grief.
- **Surprise:** stillness/tenderness where horror is expected.
- **Theme:** present (core thematic collision). **Opening:** in medias res mid-scene.
  **Beat subversion:** the "monster's true nature revealed" beat — true nature is *mercy*.
- **Subtext:** surface = clinical debrief; real = Alice realizing her whole vocation may
  be grief in disguise. **Writer warnings:** earn this; no melodrama; let silence carry.

### Chapter 4 — "Survivor"
- **POV:** Alice. **Structure:** parallel (present + the crash memory surfacing). **~4,800w.**
- **Beats:** The unprompted memory (seatbelt click / antifreeze) ambushes her. She
  confronts Acheron: *the bracelet, "you're not going to die" — did it save me in the
  crash? Did everyone else die because of me?* Survivor's guilt detonates. Acheron, cornered,
  admits the bracelet's protection but deflects the larger cost. First flare of the
  reincarnation thread: he calls her "little one" and she *almost* remembers something not
  hers. Relationship deepens through shared grief; first almost-touch.
- **Anchor:** the bracelet warm against her wrist in the cold of the memory.
- **Surprise:** he flinches/leaves rather than answer fully (his voice-under-pressure).
- **Theme:** present. **Opening:** cold-open in the memory. **Beat subversion:** the
  "backstory reveal" lands as accusation, not exposition. **Chaos:** crash memory (1st).

### Chapter 5 — PLOT TURN 1 — "The Grace Period" (~25%)
- **POV:** Alice. **Structure:** in medias res — a code (resuscitation). **~5,000w.**
- **Beats:** A code in the ward goes *wrong*: a patient who should pass **can't** — held in
  suspended agony, the monitor doing impossible things. Alice, who can see Acheron,
...
- **Theme:** present (vocation vs destiny made literal). **Opening:** in medias res code.
  **Beat subversion:** the "stakes revealed" beat — the stakes are *caused by the romance*,
  not external. **Shareable:** the reunion-started-the-clock cruelty (#2). **Writer
  warnings:** keep the cosmic stakes grounded in ONE dying body, not exposition.

---

## ACT TWO-A — FALLING & THE CLOCK (Ch.6-10, ~25-50%)

### Chapter 6 — "Off the Clock"  [theme RECEDES — breathing chapter]
- **POV:** Alice. **Structure:** domestic / quiet. **~4,700w.**
- **Beats:** A day off. Acheron, trying to court her like a person, not a destiny. Banter,
  bad hospital art (his obsession), her coffee theory, Ohio winter texture. They *like*
  each other. First real kiss — earned, light, then interrupted by a near-death somewhere
  (he must go). The world won't let them be ordinary.
- **Anchor:** the unfinished kiss; his hand on her jaw.
- **Surprise:** their first kiss interrupted by his job — comedy in the tragedy.
- **Theme:** RECEDES (this is the warmth chapter). **Opening:** quiet domestic.
  **Beat subversion:** the "first date" beat punctured by Death's pager-equivalent.
  **Chaos:** Acheron's bad-art obsession; coffee (2nd). **Heat:** kiss only.
...
- **Theme:** present. **Opening:** cold-open on the wrongness. **Beat subversion:** the
  "lore dump" beat broken into lived symptoms, not a lecture. **Chaos:** Reyes's pager tic.

### Chapter 8 — "Two Coffees"
- **POV:** Alice. **Structure:** single long scene (a real date / a night). **~5,000w.**
- **Beats:** Acheron takes her somewhere only Death could — a place between, or simply a
  diner at 3am where the dying drift through and he introduces her to *his* world gently.
  Deep intimacy, vulnerability: he tells her (some of) what he's lost across lifetimes;
  she tells him about being the survivor. They fall, properly. **Open-door MODERATE love
  scene** — sensual, earned, tender; the FIRST time, freighted with the impossibility (he
  can't be seen; she can; what are they). Ends in tenderness shadowed by the clock.
- **Anchor:** his clear blue eyes and the boatman-blade light; the warmth of a god.
- **Surprise:** he's nervous like a mortal — the eternal being undone by a first night.
- **Theme:** present. **Opening:** scene-open. **Beat subversion:** the "love scene" used to
  reveal his *fear of cost*, not just desire. **Heat:** open-door moderate (1st). **Writer
  warnings:** sensual not graphic; emotion-forward; no purple; em-dash gate.

### Chapter 9 — "Symptoms"
- **POV:** Alice. **Structure:** fragmented (short sections, days compressing). **~4,700w.**
- **Beats:** The wrongness accelerates: more impossible deaths/non-deaths at Brookwood;
...
- **Theme:** present. **Opening:** fragment/flash. **Beat subversion:** the "midpoint build"
  beat — heroine collapses *before* the midpoint reveal, not after. **Chaos:** failed
  emotional management (Alice). **Writer warnings:** handle child death with restraint.
...
## ACT TWO-B — THE COST (Ch.11-15, ~50-75%)

### Chapter 11 — "What You'll Become"
- **POV:** Alice. **Structure:** chronological. **~4,800w.**
- **Beats:** Aftermath. Alice presses Acheron: what does Lady Death *do*? He finally
  admits the part he hid: Lady Death does not save — she *takes*, she *eases*, she ends.
  To Alice the healer, this sounds like becoming the enemy she trained to fight. Crack in
  trust (he withheld). Yet a past-life fragment shows her she once *chose* this gladly.
  She's at war with her own soul. Reyes offers her a fellowship — the mortal-life door
  held open, made concrete and tempting.
- **Anchor:** the fellowship letter and the bracelet on the same wrist.
- **Surprise:** the "becoming a god" prospect rendered as a *demotion* of her vocation.
- **Theme:** present. **Opening:** scene. **Beat subversion:** the "power offered" beat — the
  power reads as loss, not gift. **Re-read payoff:** "how you want to live your life" (#5).
...
- **Theme:** present (identity across lives). **Opening:** past-life cold open. **Beat
  subversion:** the "lovers reunited" beat made sorrowful — reunion = remembering loss.

### Chapter 13 — "Borrowed Time"  [theme lightly RECEDES — intimacy]
- **POV:** Alice. **Structure:** domestic / intimacy. **~4,700w.**
...
- **Theme:** present. **Opening:** scene. **Beat subversion:** the "villain ultimatum" beat —
  delivered as compassion, not menace. **Shareable:** the vocation-as-weapon argument (#3
  lands fully).
...
- **Theme:** present (the choice at its cruelest). **Opening:** fragment. **Beat subversion:**
  the "all is lost" beat caused by the *hero's* protective lie, not the villain's strength.
  **Re-read payoff:** the bracelet (#1) at full charge. **Writer warnings:** earn the
  break; don't make Acheron a liar-for-plot — make his lie LOVE (he'd rather she stay
  herself than become his).

---

## ACT THREE — THE CHOICE (Ch.16-20, ~75-100%)
...
- **Theme:** present (thematic answer crystallizing). **Opening:** ward chronological.
  **Beat subversion:** the "hero resolves to fight" beat sparked by ordinary grief, not a
  pep talk.
...
- **Theme:** present (thematic landing). **Opening:** scene. **Beat subversion:** the
  "power-up" climax beat rendered as a *vow*, not a battle. **Shareable:** the Lady-Death
  redefinition line (#4). **Heat:** none (sacred register).
...
- **Beats:** The new equilibrium. What Alice kept and what she lost made concrete and
  ...
  worth the cost. End on a line that mirrors/answers the opening's last line.
- **Anchor:** a child at some bedside meeting Lady Death — the opening, inverted; Alice now
  the one who gives comfort and, perhaps, a bracelet.
- **Surprise:** warmth and peace where elegy is expected.
- **Theme:** present (resolved as a felt answer, not a stated one). **Opening:** quiet.
  **Beat subversion:** the "happily ever after" beat carries a real, kept grief.
  **Emotional residue:** as designed in foundation §6c. **Re-read payoffs:** "little one"
  retired (#3); full loop closed.

---

## Outline self-check
- **Progressive, not parallel:** premise lines escalate (return → falling → clock → cost →
  choice); not rearrangeable. PASS.
- **No orphan chapters:** each links back/forward (see ledger). PASS.
- **Emotional-anchor variety:** rotates object/sound/gesture/light/line. PASS.
- **Chaos distribution:** Alice (Ch2 coffee, Ch4 crash-memory, Ch9 laugh), Acheron (Ch6
  art, Ch12 cup-memory, Ch17 formality), Reyes (Ch7, Ch16 pager), spread. PASS.
- **Opening diversity:** Ch1 strange/confession then varied per ledger; no repeats
  consecutively. PASS.
- **Breathing room:** Ch6 and Ch13 RECEDE. PASS.
- **Word distribution:** 4,600-5,200; none >2× shortest. PASS. Total ≈ **96,000w** (>90k).
- **Structural diversity:** no 2 consecutive share structure (ledger). PASS.
- **Secondary-character own-life scenes:** Reyes (Ch7, Ch16), Jonah (Ch7), Amy (Ch1-2). PASS.
